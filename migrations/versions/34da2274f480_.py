...
Revision ID: 34da2274f480
Revises: 0c6446d2e575
Create Date: 2022-09-27 19:55:34.557862
...
revision = '34da2274f480'
down_revision = '0c6446d2e575'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_package', sa.String(length=120), nullable=True),
    sa.Column('id_target', sa.String(length=120), nullable=True),
    sa.Column('time_order', sa.String(length=120), nullable=True),
    sa.ForeignKeyConstraint(['id_target'], ['customer.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
