    ...
    if current_user.is_authenticated:
        if session['type'] == 2:
            ...
            if 'list_id_product' in session:
                ...
                return render_template("enterprise/order/create_order_2.html",list_customer =list_customer)
                
            else:
                
                list_product = Product.query.filter_by(id_root = id_enterprise, is_user = False)
                return render_template("enterprise/order/create_order_1.html", list_product = list_product)
    ...
    if current_user.is_authenticated:
        if session['type'] == 2:
            ...
            if 'list_id_product' in session:
                ...
                id_sender = session['id_enterprise']
                is_user = False
                status = 0
                ...
                return render_template("enterprise/order/create_order_2.html")
