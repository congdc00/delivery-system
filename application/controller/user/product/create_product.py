...
def create_product_get(session):
    if current_user.is_authenticated:
        if session['type'] == 1:
            ...
            return render_template("user/my_service/product/create_product.html", list_depot= list_depot)
    ...
    if current_user.is_authenticated:
        if session['type'] == 1:
            ...
            if nameProduct and idProduct and id_depot:
                ...
                return render_template("user/my_service/product/create_product.html")
